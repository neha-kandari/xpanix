...
const projects = [
  {
    id: 1,
    title: "Tripsee Travel Website",
    description: "A comprehensive travel website specializing in Asian destinations with beautiful destination galleries, package offerings, and seamless booking experience.",
    image: "/Tripsee.jpg",
    category: "Web Development",
    technologies: ["Next.js", "Tailwind", "Mongodb", "responsive design"],
    liveUrl: "https://www.tripseetravel.in/",
    featured: true,
  },
  {
    id: 2,
    title: "Rajasthan Auto Distributors",
    description: "A professional automotive parts e-commerce website for Mahindra genuine parts distributor with 55+ years of experience, featuring product categories, company partnerships, and contact forms.",
