    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        if (userDoc.exists()) {
          ...
          console.log("User document doesn't exist, creating it with auth data");
          // If no Firestore data, create the document with Firebase Auth data
          try {
            await setDoc(doc(db, 'users', user.uid), {
              ...
              createdVia: 'google_signin'
            });
            
            // Now set the local state
            setUserData({
              name: user.displayName || 'N/A',
              email: user.email || 'N/A',
              phone: 'N/A',
            ...
            console.warn("Failed to create user document, using auth data only:", createErr);
            // Fallback to just using auth data
            setUserData({
              name: user.displayName || 'N/A',
              email: user.email || 'N/A',
              phone: 'N/A',
        ...
        // Don't show error to user, just use auth data
        setUserData({
          name: user.displayName || 'N/A',
          email: user.email || 'N/A',
          phone: 'N/A',
